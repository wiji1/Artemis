...
public final class BufferedRenderUtils {
    private static void drawLine(
        ...
        if (x1 == x2) {
            ...
            buffer.addVertex(matrix, x1 + halfWidth, y1 - halfWidth, z).setColor(color.r, color.g, color.b, color.a);
            buffer.addVertex(matrix, x1 - halfWidth, y1 + halfWidth, z).setColor(color.r, color.g, color.b, color.a);
            buffer.addVertex(matrix, x2 + halfWidth, y2 - halfWidth, z).setColor(color.r, color.g, color.b, color.a);
            buffer.addVertex(matrix, x2 - halfWidth, y2 + halfWidth, z).setColor(color.r, color.g, color.b, color.a);
    ...
    private static void drawProgressBarForegroundWithColor(
        ...
        buffer.addVertex(matrix, xMin, yMin, 0).setColor(customColor.asInt()).setUv(txMin, tyMin);
        buffer.addVertex(matrix, xMin, yMax, 0).setColor(customColor.asInt()).setUv(txMin, tyMax);
        buffer.addVertex(matrix, xMax, yMax, 0).setColor(customColor.asInt()).setUv(txMax, tyMax);
        buffer.addVertex(matrix, xMax, yMin, 0).setColor(customColor.asInt()).setUv(txMax, tyMin);
    }
